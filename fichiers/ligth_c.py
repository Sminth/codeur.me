...
class Highlighter_c(QSyntaxHighlighter):
    def __init__(self, parent=None):
        super(Highlighter_c, self).__init__(parent)
        ...
        keywordPatterns = ["\\bchar\\b", "\\bclass\\b", "\\bconst\\b",
                ...
                "\\bvolatile\\b"]
        autres = ["\\bif\\b", "\\belse\\b", "\\breturn\\b","\\bwhile\\b","\\bfor\\b", "\\bprintf\\b","\\bscanf\\b" ]
        ...
        quota = QTextCharFormat()
        quota.setForeground(Qt.darkGreen)
        self.highlightingRules.append((QRegExp("<.*>"), quota))
